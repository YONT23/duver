<template>
    ...
    <div class="alert alert-success" role="alert">
        <center>
            <p>Consulta a la tabla personas que nos retorna los registros de forma ordenada...</p>
...
export default {
    ...
    mounted() {
        axios.get('http://127.0.0.1:8000/inmueble/consulta6/').then(response => this.cc = response.data)
    },
    methods: {
        descargarPdf() {
