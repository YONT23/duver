<template>
    ...
    <div class="alert alert-success" role="alert">
        <center>
            <p>Consulta a la tabla personas que nos retorna los registros, excluyendo a todo 
                aquellos que contengan en el campo ciudad "San Juan"</p>
...
export default {
    ...
    mounted() {
        axios.get('http://127.0.0.1:8000/inmueble/consulta5/').then(response => this.cc = response.data)
    },
    methods: {
        descargarPdf() {
